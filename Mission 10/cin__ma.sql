...
--
-- Hôte : localhost
-- Généré le : mar. 09 déc. 2025 à 15:46
...
(1, 'DURIS', 'Romain', '1974-05-28', 80),
(2, 'EXARCHOPOULOS', 'Adèle', '1993-11-22', 23),
...
CREATE TABLE `film` (
  `IDENT_FILM` int NOT NULL,
  `TITRE` varchar(125) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `realisateur` (
  `IDENT_REALISATERUR` int NOT NULL,
  `NOM` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `PRENOM` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `DATE_NAISSANCE` date NOT NULL,
...
INSERT INTO `realisateur` (`IDENT_REALISATERUR`, `NOM`, `PRENOM`, `DATE_NAISSANCE`, `NB_FILM_ECRIT`, `NB_FILM_PRODUIT`) VALUES
...
ALTER TABLE `realisateur`
  ADD PRIMARY KEY (`IDENT_REALISATERUR`);
COMMIT;
